...
// submit tx for send 1 eth to 0x123... ใช้ Javascript VM ตั้งค่า value หน่วย Ether พร้อมใส่ค่า 1 Ether (สอดคล้องกับจำนวนที่จะโอนใน submit tx) หลังจาก deploy แล้วให้กด deposit (โอน 1 Ether เข้า contract นี้) ก่อน owner ถึงจะ execute ได้ 
// 0x123..., 1000000000000000000, 0x00
